...
toastElement.style.animation = `fadeIn 0.3s, fadeOut 0.3s ${(_0x323295 / 0x3e8 - 0.3)}s forwards`;

switch (status) {
  case "success":
    toastElement.style.backgroundColor = "rgba(16, 185, 129, 0.9)";
    break;
  case "error":
    toastElement.style.backgroundColor = "rgba(239, 68, 68, 0.9)";
    break;
  default:
    toastElement.style.backgroundColor = "rgba(99, 102, 241, 0.9)";
}

toastElement.innerHTML = `
  <div style="display: flex; align-items: center;">
  <span style="margin-right: 10px; font-size: 18px;">${iconHTML}</span>
  <span style="color: white;">${messageContent}</span>
</div>
