...
var scriptConfig = {
  ROOT_DOMAIN: "jamu.workers.dev",
  SERVICE_NAME: "dada",
  API_KEY: "fa084f134063e11cd2e1f468dc91",
  API_EMAIL: "desalekong24@gmail.com",
  ACCOUNT_ID: "fbfeda4c47ab239766f6415",
  ZONE_ID: "91920c3ea377e15d31be40038",
  OWNER_PASSWORD: "7",
  CLOUDFLARE_API_TOKEN: "cfGVY7NrOEaUnW3rknUHUzs07dCcUOFVfd4XjQw8b677c58"
};
var proxyListURL = "https://raw.githubusercontent.com/paoandest/botak/refs/heads/main/cek/proxyList.txt";
var telegrambot = "https://t.me/VLTRSSbot";
var GALAXY_ANIMATION_COMPONENT = `
...
<body class="blur-background">
  ...
  <script type="module">
    ...
    // final: from right-top, diagonal wide (angle ~37\xB0 down to origin)
...
async function handleCheck(paramss, request, ctx) {
  ...
  try {
    ...
    const responseData = {
      ...
      status: result.status === "ACTIVE" ? "\u2705 Aktif" : "\u{1F62D}"
    };
...
async function handleSubRequest(hostnem) {
  const proxyListURL2 = "https://raw.githubusercontent.com/jaka1m/botak/refs/heads/main/cek/proxyList.txt";
...
async function handleWebRequest(request) {
  ...
  const fetchConfigs = /* @__PURE__ */ __name(async () => {
    try {
      ...
      let pathCounters = {};
      const configs2 = rawProxyList.map((config) => {
...
// .wrangler/tmp/bundle-tZay1x/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-tZay1x/middleware-loader.entry.ts
